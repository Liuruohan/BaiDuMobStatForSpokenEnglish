...
/**
 日志发送策略
 */
typedef enum _BaiduMobStatLogStrategyForSpokenEnglish {
    BaiduMobStatLogStrategyAppLaunchForSpokenEnglish = 0,   //每次程序启动时发送（默认策略，推荐使用!）
} BaiduMobStatLogStrategyForSpokenEnglish;

/**
 推送平台定义
 */
typedef enum _BaiduMobStatPushPlatformForSpokenEnglish{
    BaiduMobStatPushPlatformBaiduCloudForSpokenEnglish = 0, //百度云推送平台
    BaiduMobStatPushPlatformJiGuangForSpokenEnglish = 1,    //极光推送平台
    BaiduMobStatPushPlatformGeTuiForSpokenEnglish = 2,      //个推推送平台
} BaiduMobStatPushPlatformForSpokenEnglish;

/**
 百度移动应用统计接口
 当前版本 4.8.3_0
 */
@interface BaiduMobStatForSpokenEnglish : NSObject
/**
 以下property属性，均为可选设置
 */
 ...
 */
@property (nonatomic) BaiduMobStatLogStrategyForSpokenEnglish logStrategy;
...
/**
 ...
 @return 一个统计对象实例
 */
+ (BaiduMobStatForSpokenEnglish *)defaultStat;
 ...
 */
- (void)setPushId:(NSString *)pushId platform:(BaiduMobStatPushPlatformForSpokenEnglish)platform;
@end
